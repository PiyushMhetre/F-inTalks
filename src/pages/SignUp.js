...
>
  ...
  <div className="mb-3">
    ...
    <input
      ...
      className="flex mt-1 h-12 w-[18em] laptop:w-[30em] rounded-md border border-gray-400 bg-transparent px-3 text-sm text-gray-700 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:opacity-50 dark:border-gray-700 dark:text-gray-50 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
    />
  </div>
