...
export default function FeedHeader() {
  ...
  const [profile, setProfile] = useState(
    "http://res.cloudinary.com/dicevyk4v/image/upload/v1718561564/wbdquq18b6sy8e7uu1en.jpg"
  );
  ...
  return (
    <div className=" ">
      <div className="w-full fixed top-0 z-10 shadow-md p-1 flex justify-around bg-white">
        <div className="flex gap-6 desktop:gap-60 laptop:gap-28 laptop:justify-between mt-1">
          <div className="laptop:h-8 flex gap-2 laptop:gap-2">
            ...
            <div className="laptop:mt-4 relative flex items-center">
              ...
              <form onSubmit={handleSearchSubmit}>
                <input
                  type="text"
                  placeholder="'Fintech',  'Google',  'BNY',  'Web Dev',  'John Doe'"
          ...
          <div className="flex gap-2 laptop:gap-3 desktop:gap-7 h-5 laptop:h-12 text-xs mt-1">
            <Link
              to="/feed"
            ...
            >
              <div className="hidden text-base mobile:flex laptop:hidden tablet:hidden desktop:hidden items-center">
                <IoIosNotificationsOutline />
              </div>
              <div className="mobile:hidden laptop:block tablet:block desktop:block">Notifications</div>
              {newNotificationFlag && (
                <span className="absolute laptop:top-3 mobile:bottom-2 -right-1 laptop:-right-2 transform bg-red-600 text-white rounded-full laptop:w-4 laptop:h-4 z-10 w-3 h-3">
                  <div className="absolute text-xs laptop:text-base left-[2px] -top-[1.3px] laptop:left-1 laptop:-top-1">
                    {newNotificationCount}
                  </div>
                </span>
              )}
